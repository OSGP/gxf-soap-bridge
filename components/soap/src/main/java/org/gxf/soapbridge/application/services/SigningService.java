...
import org.gxf.soapbridge.application.properties.SigningConfigurationProperties;
...
public class SigningService {
     ...
     * @param securityKey The signature a.k.a. security key which was created using
     *                    {@link SigningService#signContent(String)}.
    ...
    private byte[] createSignature(final byte[] message) throws GeneralSecurityException {
        final Signature signatureBuilder = Signature.getInstance(signingConfiguration.getSignature(), signingConfiguration.getProvider());
