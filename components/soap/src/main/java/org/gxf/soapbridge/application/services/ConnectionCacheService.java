...
public class ConnectionCacheService {
    ...
    /**
     * Map used to cache connections. The key is a random string generated by
     * {@link RandomStringFactory}. The value is a {@link Connection} instance.
     */
     ...
     *
     * @param connectionId The key for the {@link Connection} instance obtained by calling
     *                     {@link ConnectionCacheService#cacheConnection()}.
     * @return A {@link Connection} instance.
     * @throws ConnectionNotFoundInCacheException In case the connection is not present in the
