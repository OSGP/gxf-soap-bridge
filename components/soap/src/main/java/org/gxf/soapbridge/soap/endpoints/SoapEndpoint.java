...
/**
 * This {@link @Component} class is the endpoint for incoming SOAP requests from client applications.
 */
@Component
public class SoapEndpoint implements HttpRequestHandler {
    ...
    private static final String SOAP_HEADER_KEY_ORGANISATION_IDENTIFICATION = "OrganisationIdentification";
    private static final String SOAP_HEADER_KEY_USER_NAME = "UserName";
    private static final List<String> SOAP_HEADER_KEYS = List.of(
    ...
    public static final String X_509_CERTIFICATE_REQUEST_ATTRIBUTE = "jakarta.servlet.request.X509Certificate";
     ...
     */
    @Autowired
    private ProxyRequestsMessageSender proxyRequestsMessageSender;
    ...
    public void handleRequest(final HttpServletRequest request, final HttpServletResponse response)
        ...
        if (request.getAttribute(RequestAttributeSecurityContextRepository.DEFAULT_REQUEST_ATTR_NAME) instanceof final SecurityContext securityContext) {
        ...
        try {
            proxyRequestsMessageSender.send(requestMessage);
    ...
    private String getContextForRequestType(
    ...
    private X509Certificate[] getX509CertificatesFromServlet(final HttpServletRequest request) {
        final Object x509CertificateAttribute = request.getAttribute(X_509_CERTIFICATE_REQUEST_ATTRIBUTE);
