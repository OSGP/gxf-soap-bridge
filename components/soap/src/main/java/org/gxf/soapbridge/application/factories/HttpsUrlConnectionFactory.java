...
public class HttpsUrlConnectionFactory {
     ...
     */
    @Autowired
    private SslContextCacheService sslContextCacheService;
     ...
     * @param host          The host consists of domain name, server name or IP address followed by
     *                      the port. Example: localhost:443
     ...
     * @return Null in case the {@link SSLContext} cannot be created or fetched from the
     * {@link SslContextCacheService}, or a configured and initialized {@link HttpsURLConnection}
     * instance.
     * @throws UnableToCreateHttpsURLConnectionException In case the configuration and/or
     *                                                   initialization of an
     *                                                   {@link HttpsURLConnection} instance fails.
     */
    public HttpsURLConnection createConnection(
        ...
        try {
            ...
            HttpsURLConnection.setDefaultHostnameVerifier(
                    hostnameVerifierFactory.getHostnameVerifier());
