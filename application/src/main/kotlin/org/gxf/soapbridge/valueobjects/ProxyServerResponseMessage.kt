...
class ProxyServerResponseMessage(connectionId: String, val soapResponse: String) :
    ...
    override fun getFieldsForMessage(): List<String> = listOf(connectionId, encode(soapResponse))
    ...
    companion object {
        ...
        fun createInstanceFromString(string: String): ProxyServerResponseMessage {
            ...
            if (numTokens < 3) {
                throw ProxyMessageException("Invalid number of tokens, don't try to create ProxyServerResponseMessage")
            }
